        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <Input id="new-password" name="new-password" type="password" value={password} onChange={e => setPassword(e.target.value)} disabled={submitting || !token} required minLength={8} aria-required="true" />
            </div>
            <div>
              <label htmlFor="confirm-password" className="block text-sm mb-1">Confirm Password</label>
              <Input id="confirm-password" name="confirm-password" type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)} disabled={submitting || !token} required minLength={8} aria-required="true" />
            </div>
