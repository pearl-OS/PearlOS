...
# Script to get current logs from the dashboard-stg workspace service container
# Usage: ./scripts/get-dashboard-stg-logs.sh [options]

set -e

# Configuration
ENV="stg"
NAMESPACE="dashboard-${ENV}"
...
Get current logs from the dashboard-stg workspace service container.
...
OPTIONS:
    ...
    -n, --namespace NAME   Kubernetes namespace (default: dashboard-{env})
