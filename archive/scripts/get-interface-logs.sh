...
# Script to get current logs from the interface-stg workspace service container
# Usage: ./scripts/get-interface-stg-logs.sh [options]

set -e

# Configuration
ENV="stg"
NAMESPACE="interface-${ENV}"
...
Get current logs from the interface-stg workspace service container.
...
OPTIONS:
    ...
    -n, --namespace NAME   Kubernetes namespace (default: interface-{env})
