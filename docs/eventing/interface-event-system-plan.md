# MOVED: Interface Event System — Planning Document

This planning document moved to transitions to align with the docs policy.

Canonical copy:

- docs/transitions/eventing/interface-event-system-plan.md

Related active doc:

- docs/eventing/interface-event-system-rfc.md (in-progress direction)
